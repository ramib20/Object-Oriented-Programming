 ...
 * @version 1.0 This class is a wrapper over different traits of a Start-up Idea
 */
public class StartUpIdea implements Comparable<StartUpIdea> {
    ...
    private String feasable;
    private double sustainableCoeff = 1.0;
    private double feasableCoeff = 1.0;
     ...
     * @param sustainable            is idea sustainable
     * @param feasable               is idea feasable

     */
    public StartUpIdea(String problem, String targetCustomer, int customerNeed, int knownPeopleWithProblem,
            int targetMarketSize, String competitors, String sustainable, String feasable) {
    ...
    public String toString() {
        ...
        str += "Sustainable: " + sustainable + "\n";
        str += "Feasable: " + feasable + "\n";
        return str;
    }
     ...
     *         less than, equal to, or greater than the specified object. //EX:
     *         startUpIdeaA.compareTo(startUpIdeaB) returns -5,
     */ // meaning startupIdeaA is less than startUpIdeaB
    public int compareTo(StartUpIdea other) {
        if (sustainable.equals("Yes")) {
            sustainableCoeff = 1.50;
        }

        if (feasable.equals("Yes")) {
            feasableCoeff = 1.25;
        }
        int totalCustomerDesireDiff = ((int) Math.floor(sustainableCoeff * feasableCoeff
                * (this.customerNeed * (this.targetMarketSize + this.knownPeopleWithProblem * 10000))))
                - ((int) Math.floor(sustainableCoeff * feasableCoeff
